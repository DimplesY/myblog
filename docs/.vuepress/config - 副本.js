...
module.exports = {
  ...
  description: 'Dimples的博客，小小小杰啊的博客，web技术博客,简洁至上,专注web学习与总结。JavaScript,js,ES6,TypeScript,vue,python,css3,html5,Java,git,github等技术文章。', // 描述,以 <meta> 标签渲染到页面html中
  // base: '/', // '/<github仓库名>/'， 默认'/'
  ...
  plugins: [ // 插件
    ...
    [
      ...
      {
        hm: 'b1c41e1362967e6ed18894d7bab0f58d'
      }
    ],
    [
