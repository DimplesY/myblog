...
- name: XiaoLi Blog # 昵称
  ...
  bgColor: "#70f3ff" # 可选，默认var(--bodyBg)。颜色值有#号时请添加单引号
...
- name: HikariLan's Blog
  ...
  bgColor: "#ff2d51" # 可选，默认var(--bodyBg)。颜色值有#号时请添加单引号
...
- name: CodeSnake的数据库日志 # 昵称
  desc: DON'T ASPIRE TO MAKE A LIVING, ASPIRE TO MAKE A DIFFERENCE. # 介绍
  avatar: https://oss.codesnake.space/img/logo.png # 头像
  link: https://blog.codesnake.space # 链接
  bgColor: "#19122a" # 可选，默认var(--bodyBg)。颜色值有#号时请添加单引号
  textColor: "#D1D5DB" # 可选，默认var(--textColor)
